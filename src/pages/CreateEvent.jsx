            ...
            <div style={{ maxWidth: '850px', margin: '0 auto', padding: '0 20px' }}>
                ...
                {submitted ? (
                    <motion.div
                        ...
                        style={{ textAlign: 'center', padding: '100px 40px', backgroundColor: '#f0fdf4', borderRadius: '32px', border: '2px solid #bbf7d0' }}
                    >
                        <CheckCircle2 size={64} color="#16a34a" style={{ marginBottom: '20px' }} />
                        <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#166534', marginBottom: '10px' }}>Booking Submitted!</h2>
                        <p style={{ color: '#166534', opacity: 0.8 }}>Your request for the Seminar Hall is now pending approval.</p>
                        <p style={{ marginTop: '20px', fontSize: '0.9rem', color: '#166534' }}>Redirecting to dashboard...</p>
                    </motion.div>
                ) : (
