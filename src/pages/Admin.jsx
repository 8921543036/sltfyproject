...
import { CheckCircle2, XCircle, Clock, Search, Filter, Calendar, MapPin, User, ChevronRight, LayoutDashboard } from 'lucide-react';
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '40px' }}>
                    <div>
                        ...
                        <p style={{ color: '#64748b', fontSize: '1.1rem' }}>Manage venue bookings and event requests</p>
                    </div>
