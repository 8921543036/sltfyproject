            ...
            <div style={{ flex: 1 }}>
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <p style={{ fontSize: '1.2rem', color: '#666', fontWeight: '500', marginBottom: '20px' }}>
                            {currentVenue.type}
                        </p>
                        <p style={{ fontSize: '1.1rem', color: '#888', maxWidth: '400px', marginBottom: '30px' }}>
                    ...
                    {venues.map((_, i) => (
                        <div
                            ...
                            style={{
                                ...
                                height: '10px',
                                borderRadius: '5px',
                                backgroundColor: i === index ? '#000' : '#ddd',
                                cursor: 'pointer',
